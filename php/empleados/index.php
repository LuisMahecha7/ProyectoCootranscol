...
<body>
    ...
    //include("../RegistrarNuevoVehiculo/php/conexion.php");
//require_once("../RegistrarNuevoVehiculo/php/conexion.php");
    ...
    <h1 class="text-center mt-5 mb-5 fw-bold">REGISTRO DE EMPLEADOS</h1>
