    ...
    <body>
        ...
        <div class="menu">
            ...
            <div style="text-align: center;">
                <img src="../resourses/logo3.png" alt="Logo" style="width: 270px; height: auto; margin-bottom: 50px;" />
            </div>
            ...
            <span class="tooltip">Añadir un nuevo vehículo al sistema</span>
                ...
                <a href="./RegistrarNuevoVehiculo/php/index.php">Gestionar Vehículos
                    <span class="tooltip">Ver y gestionar todos los vehículos registrados</span>
                </a>
                <a href="#">Historial de Mantenimiento
                ...
                <a href="#">Alertas de Mantenimiento
        ...
        ">
    <h4>
        <span style="font-style: italic; font-weight: bold; color: #333;">C</span>ootranscol 2024 - Todos los derechos reservados
    </h4>
</div>
